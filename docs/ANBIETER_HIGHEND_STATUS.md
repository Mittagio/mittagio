...
| **Kochbuch** | `v-provider-cookbook` | Oben Kategorie-Pills (Alle, Vegetarisch, Vegan, Fisch, Mit Fleisch), Bestseller-Strip, 1-Spalte Karten 24px, Sticky Action-Bar, #F8F7F2. |
