...
- Leerer Zustand: „Mittagsbox leer – Gericht aus Entdecken wählen.“
- Aktive Abholnummer: kompakter Hero, monospace Code, Session-Karten mit Card-Look.
- `phase2-customer` auch auf Entdecken für einheitlichen Surface-Hintergrund.

## Update: Phase 2 Relaunch (26.05.2026)

- Mittagsbox-Surface (`#cartMainCard`) ist auf Premium-Card-Look gehoben (Radius, feiner Border, tieferer Soft-Shadow).
- Der Abholnummer-Hero wurde visuell staerker fokussiert, ohne die Session-Logik zu aendern.
- Spacing und Lesefluss sind auf den gleichen Customer-Standard wie Favoriten/Checkout gebracht.
