...
## Phase 6 – Applike Kochbuch (26.05.2026)

- **Scope:** Nur UI auf `#v-provider-cookbook`; Magazin-Karten, Sheets und Kochbuch-Logik unverändert.
- **Klassen:** `phase6-applite`; Header-Titel „Kochbuch“.
- **Copy:** Empty State „Noch leer“, kürzere CTAs („200 Gerichte laden“, „Erstes Gericht anlegen“).
- **Layout:** Magazin-Karten 20px Radius, Empty-State-Buttons min. 56px.
