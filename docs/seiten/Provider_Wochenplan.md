...
## Phase 6 – Applike Wochenplan (26.05.2026)

- **Scope:** Nur Optik/Microcopy auf `#v-provider-week` und zugehörigen Sheets (KW/Magic/Vorlage); keine Plan-Logik.
- **Klassen:** `phase6-applite`; Sheet-Titel gekürzt („KW wählen“, „Wochen-Ideen“, „Vorlage“).
- **Copy:** Header „Wochenplan“, Empty-Hint „Tippen zum Füllen“.
- **Layout:** Tageskarten/Renner-Tiles mit weicheren Schatten, min. 48–60px Touch-Ziele.
